...
import dev.obit.tools.autobots.model.HierarchyData;

/**
 * Used to mark an object as hierarchical data.
 * This object can then be used as data source for an hierarchical control, 
 * like the {@link javafx.scene.control.TreeView}.
 *
 * @author Christian Schudt
 */
public class TreeViewX<T extends HierarchyData<T>> extends TreeView<T>{
     ...
     */
    public TreeViewX(TreeItem<T> root) {
        super(root);
        init();
    }
    ...
    /**
     * Removes all listeners from a root.
     *
     * @param root The root.
     */
